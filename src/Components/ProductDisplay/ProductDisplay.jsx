  ...
  return (
    <div className="productdisplay">
      ...
      <div className="imagenes-left">
        <div className="productdisplay-img-list">
          <img
            src={product.image}
            alt=""
            className={selectedImage === product.image ? "selected" : ""}
            onClick={() => setSelectedImage(product.image)}
          />
          <img
            src={product.image2}
            alt=""
            className={selectedImage === product.image2 ? "selected" : ""}
            onClick={() => setSelectedImage(product.image2)}
          />
          <img
            src={product.image3}
            alt=""
            className={selectedImage === product.image3 ? "selected" : ""}
            onClick={() => setSelectedImage(product.image3)}
          />
          <img
            src={product.image4}
            alt=""
            className={selectedImage === product.image4 ? "selected" : ""}
      ...
      <div className="productdisplay-right">
            ...
            {Object.keys(product.sizes).map((size, index) => (
              <div
                ...
                className={`size-button ${
                  ...
                  !product.sizes[size] ? "disabled-no-size" : ""
                }`}
        ...
        {!selectedSize && (
          <div className="error-message">Seleccione la talla</div>
        )}
